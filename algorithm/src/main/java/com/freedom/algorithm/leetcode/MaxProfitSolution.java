 ...
 * (price = 5), profit = 5-1 = 4. Note that you cannot buy on day 1, buy on day 2 and sell them
 * later, as you are engaging multiple transactions at the same time. You must sell before buying
 * again. Example 3:
 * <p>
 * Input: prices = [7,6,4,3,1] Output: 0 Explanation: In this case, no transaction is done, i.e.,
 * max profit = 0.  
 * <p>
 * Constraints:
 * <p>
 ...
 * <p>
 * 作者：力扣 (LeetCode) 链接：https://leetcode-cn.com/leetbook/read/top-interview-questions-easy/x2zsx1/
